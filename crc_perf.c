...
//	XMC_FCE_Init(&FCE_config0);
  ...
  temp_mismatch = 0;
	 ...
	 */
	printf("Step 1: Performs a CRC32 check using Kernel 0 on Usecase1_Data1\n");
   ...
   */
	printf("Step 2: Performs a CRC32 check using Kernel 1 on Usecase1_Data1\n");
   ...
   */
	printf("Step 3: Performs a CRC32 check using Kernel 1 on Usecase1_Data2\n");
  XMC_FCE_InitializeSeedValue(&g_FCE_1, 0);
  XMC_FCE_UpdateLength(&g_FCE_1, temp_length);
   ...
   */
	printf("Step 4: Performs a CRC16 check using Kernel 2 on Usecase1_Data3.\n");
...
//  XMC_FCE_InitializeSeedValue(p_fce, 0xffff);
   ...
   */
	printf("Step 5: Performs a CRC8 check using Kernel 3 on Usecase1_Data4.\n");
   ...
   */
	printf("Step 6: Trigger a mismatch flag.\n");
